...
class CoreService:
    ...
    def transaction(self, key, amount):
    ...
    def register_key(self, key, key_type, user_id):
        self.token, self.expiration_time = self.get_token_with_expiration()
    ...
    def register_user(self, name, email, cpf, phone):
        self.token, self.expiration_time = self.get_token_with_expiration()
...
if __name__ == '__main__':
    ...
    response = core_service.register_user(
        'Test User 6', 'test.user.6@email.com', '944.457.293-23', '(31) 99722-9823')
    print(response)
